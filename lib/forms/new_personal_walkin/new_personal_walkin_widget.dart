...
import 'new_personal_walkin_model.dart';
export 'new_personal_walkin_model.dart';

class NewPersonalWalkinWidget extends StatefulWidget {
  const NewPersonalWalkinWidget({
    Key? key,
    required this.newWalkin,
  }) : super(key: key);

  final dynamic newWalkin;

  @override
  _NewPersonalWalkinWidgetState createState() =>
      _NewPersonalWalkinWidgetState();
}

class _NewPersonalWalkinWidgetState extends State<NewPersonalWalkinWidget>
    with TickerProviderStateMixin {
  late NewPersonalWalkinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewPersonalWalkinModel());
    ...
    _model.aGValueController ??= TextEditingController();
    _model.paymentSchemeController ??= TextEditingController();
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  24.0, 4.0, 0.0, 10.0),
                                          child: Text(
                                            'Below are the visit details to be filled',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  fontFamily:
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    cursorColor:
                                                        Color(0xFF6F61EF),
                                                    validator: _model
                                                        .paymentSchemeControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      24.0, 4.0, 0.0, 10.0),
                                              child: Text(
                                                'Below are the payment details to be filled',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  24.0, 4.0, 0.0, 10.0),
                                          child: Text(
                                            'Below are the Chanel Partner details to be filled',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                                  fontFamily:
                            ...
                            children: [
                              ...
                              if (_model.currenTab == 1)
                                FFButtonWidget(
                                  onPressed: () async {
                                    setState(() {
                                      _model.currenTab = _model.currenTab + 1;
                                    });
                                  },
                                  text: 'Next',
                                  options: FFButtonOptions(
