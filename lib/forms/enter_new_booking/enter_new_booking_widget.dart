...
class _EnterNewBookingWidgetState extends State<EnterNewBookingWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().addToOwnerList(functions.getOwnerEmptyJson());
      });
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            FFAppState().removeFromOwnerList(FFAppState().ownerList[ownerIndex]);
                                                                          });
                                                                        },
                                                                      ),
                                                                    ),
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              cursorColor: Color(0xFF6F61EF),
                                              validator: _model
                                                  .agreementValueControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                          ...
                                          children: [
                                            Expanded(
                                              child:
                                                ...
                                                controller: _model
                                                        .unitNoValueController ??=
                                                    FormFieldController<String>(
                                                        null),
                                                options:
                                                    functions.getDropdownItems(
                                                        FFAppState()
                                                            .UnitMasterList
                                                            .toList()),
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    cursorColor:
                                                        Color(0xFF6F61EF),
                                                    validator: _model
                                                        .bookingDateControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
