...
class _EnterNewBookingWidgetState extends State<EnterNewBookingWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().addToOwnerList(FFAppState().ownerJson);
      });
    });
    ...
    _model.branchController1 ??= TextEditingController();
    ...
    _model.branchController2 ??= TextEditingController();
    _model.branchController3 ??= TextEditingController();
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        'LET\'S START WITH BOOKING DETAILS',
                                ...
                                builder: (context) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, ownerIndex) {
                                      final ownerItem = owner[ownerIndex];
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          Padding(
                                                        ...
                                                        Expanded(
                                                          child: wrapWithModel(
                                                            model: _model
                                                                ...
                                                                .getModel(
                                                              'booking_name_${ownerIndex.toString()}',
                                                              ownerIndex,
                                                            ),
                                                            updateCallback:
                                                                () => setState(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Expanded(
                                                          child: wrapWithModel(
                                                            model: _model
                                                                ...
                                                                .getModel(
                                                              'booking_email_${ownerIndex.toString()}',
                                                              ownerIndex,
                                                            ),
                                                            updateCallback:
                                                                () => setState(
                                                        ...
                                                        BookingPanComponentWidget(
                                                          key: Key(
                                                              'Key5g2_${ownerIndex}_of_${owner.length}'),
                                                          pan: getJsonField(
                                                            ownerItem,
                                                            r'''$.pan''',
                                                          ).toString(),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        setState(() {
                                          _model.multipleOwners = 1;
                                        });
                                        setState(() {
                                          FFAppState().addToOwnerList(
                                              FFAppState().ownerJson);
                                        });
                                      },
                                    ),
                                    Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          setState(() {
                                            _model.multipleOwners =
                                                _model.multipleOwners + -1;
                                          });
                                          setState(() {
                                            FFAppState().removeFromOwnerList(
                                                FFAppState().ownerJson);
                                          });
                                        },
                                      ),
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Container(
                                      width: 200.0,
                                      child: TextFormField(
                                        controller: _model.contactController3,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Container(
                                    width: 200.0,
                                    child: TextFormField(
                                      controller: _model.branchController1,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller: _model.flatNoValueController ??=
                                        FormFieldController<String>(null),
                                    options: ['101', '102', '103', '104'],
                                    onChanged: (val) => setState(
                                        () => _model.flatNoValue = val),
                                    width: 300.0,
                                    height: 40.0,
                                    textStyle:
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      maxLines: null,
                                      cursorColor: Color(0xFF6F61EF),
                                      validator: _model.amtControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Container(
                                    width: 150.0,
                                    child: TextFormField(
                                      controller: _model.checkRefNoController,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                                        labelText: 'Check/Ref No',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Plus Jakarta Sans',
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      5.0, 10.0, 0.0, 0.0),
                                  child: FlutterFlowDropDown<String>(
                                    controller: _model.modeValueController ??=
                                        FormFieldController<String>(null),
                                    options: ['Check', 'UPI', 'Neft', 'Cash'],
                                    onChanged: (val) =>
                                        setState(() => _model.modeValue = val),
                                    height: 40.0,
                                    textStyle:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                    hintText: 'Mode',
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Container(
                                    width: 200.0,
                                    child: TextFormField(
                                      controller: _model.branchController2,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Container(
                                    width: 200.0,
                                    child: TextFormField(
                                      controller: _model.branchController3,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
