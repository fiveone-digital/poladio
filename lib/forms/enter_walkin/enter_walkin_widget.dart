...
class _EnterWalkinWidgetState extends State<EnterWalkinWidget>
  ...
  void initState() {
    ...
    _model.contactController4 ??= TextEditingController();
    _model.contactController5 ??= TextEditingController();
    _model.contactController6 ??= TextEditingController();
    _model.addressController ??= TextEditingController();
    _model.agreementValueController1 ??= TextEditingController();
    _model.agreementValueController2 ??= TextEditingController();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: 150.0,
                                        child: TextFormField(
                                          controller: _model.contactController4,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.agreementValueController1,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                          ...
                                          cursorColor: Color(0xFF6F61EF),
                                          validator: _model
                                              .agreementValueController1Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.agreementValueController2,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                          ...
                                          cursorColor: Color(0xFF6F61EF),
                                          validator: _model
                                              .agreementValueController2Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            controller: _model
                                                    .unitNoValueController3 ??=
                                                FormFieldController<String>(
                                                    null),
                                            options: ['1BHK', '2BHK', '3BHK'],
                                            onChanged: (val) => setState(() =>
                                                _model.unitNoValue3 = val),
                                            width: 180.0,
                                            height: 40.0,
                                            textStyle:
                                                FlutterFlowTheme.of(context)
