...
class _EditWalkinWidgetState extends State<EditWalkinWidget>
  ...
  void initState() {
    ...
    _model.interstedController ??= TextEditingController(
        text: getJsonField(
      widget.walkinDetail,
      r'''$.interested_in''',
    ).toString().toString());
    _model.reasonPurchController ??= TextEditingController(
        text: getJsonField(
      widget.walkinDetail,
                                                ...
                                                child: Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    cursorColor:
                                                        Color(0xFF6F61EF),
                                                    validator: _model
                                                        .reasonPurchControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                _model.bookingCreate = await PoladioAPIsGroup
                                  ...
                                  interestedIn: _model.interstedController.text,
                                  budget: _model.budgetController.text,
                                  locationPreferred:
                                      _model.locPrefController.text,
                                  source: _model.sourceController.text,
                                  reasonForPurchase:
                                      _model.reasonPurchController.text,
                                  officeAddress:
