...
class _EditBookingWidgetState extends State<EditBookingWidget>
  ...
  void initState() {
    ...
    _model.bookingNameController1 ??= TextEditingController(
        text: getJsonField(
      widget.editBooking,
      r'''$.owner.name''',
    ).toString().toString());
    _model.panCardController1 ??= TextEditingController(
        text: getJsonField(
      widget.editBooking,
      r'''$.owner.pan''',
    ).toString().toString());
    ...
    _model.bookingNameController2 ??= TextEditingController(
        text: getJsonField(
      widget.editBooking,
      r'''$.owner.name''',
    ).toString().toString());
    _model.panCardController2 ??= TextEditingController(
        text: getJsonField(
      widget.editBooking,
      r'''$.owner.pan''',
    ).toString().toString());
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            cursorColor: Color(
                                                                0xFF6F61EF),
                                                            validator: _model
                                                                .bookingNameController1Validator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            cursorColor: Color(
                                                                0xFF6F61EF),
                                                            validator: _model
                                                                .bookingNameController2Validator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
