...
import 'visit_profile_details_model.dart';
export 'visit_profile_details_model.dart';

class VisitProfileDetailsWidget extends StatefulWidget {
  ...
  _VisitProfileDetailsWidgetState createState() =>
      _VisitProfileDetailsWidgetState();
}

class _VisitProfileDetailsWidgetState extends State<VisitProfileDetailsWidget>
    with TickerProviderStateMixin {
  late VisitProfileDetailsModel _model;
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: VisitProfileEditWidget(
                                        editWalkin: widget.walkinDetail!,
                                      ),
                                    );
                                  },
                                ).then((value) => setState(() {}));
                            ...
                            onPressed: () async {
                              await showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return Padding(
                                    padding: MediaQuery.viewInsetsOf(context),
                                    child: ChannelPartnerDetailsWidget(),
                                  );
                                },
                              ).then((value) => setState(() {}));
                            },
