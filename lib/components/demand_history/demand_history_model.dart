...
class DemandHistoryModel extends FlutterFlowModel {
  ...
  // State field(s) for NetGst widget.
  TextEditingController? netGstController;
  String? Function(BuildContext, String?)? netGstControllerValidator;
  // State field(s) for DemandType widget.
  TextEditingController? demandTypeController;
  String? Function(BuildContext, String?)? demandTypeControllerValidator;
  ...
  void dispose() {
    ...
    netGstController?.dispose();
    demandTypeController?.dispose();
  }
